...
if(DISTRO_NIX)
    ...
    FetchContent_Declare(zlib           SOURCE_DIR "${NIX_DEPS_DIR}/zlib"                                 )
    FetchContent_Declare(luajit         SOURCE_DIR "${NIX_DEPS_DIR}/luajit"         SOURCE_SUBDIR fakedir )
    FetchContent_Declare(lua_cjson      SOURCE_DIR "${NIX_DEPS_DIR}/luajson"        SOURCE_SUBDIR fakedir )
    FetchContent_Declare(minhook        SOURCE_DIR "${NIX_DEPS_DIR}/minhook"        SOURCE_SUBDIR fakedir )
    FetchContent_Declare(mini           SOURCE_DIR "${NIX_DEPS_DIR}/mini"           SOURCE_SUBDIR fakedir )
    FetchContent_Declare(websocketpp    SOURCE_DIR "${NIX_DEPS_DIR}/websocketpp"    SOURCE_SUBDIR fakedir )
    FetchContent_Declare(fmt            SOURCE_DIR "${NIX_DEPS_DIR}/fmt"            SOURCE_SUBDIR fakedir )
    FetchContent_Declare(nlohmann_json  SOURCE_DIR "${NIX_DEPS_DIR}/json"           SOURCE_SUBDIR fakedir )
    FetchContent_Declare(libgit2        SOURCE_DIR "${NIX_DEPS_DIR}/libgit2"        SOURCE_SUBDIR fakedir )
    FetchContent_Declare(minizip_ng     SOURCE_DIR "${NIX_DEPS_DIR}/minizip"        SOURCE_SUBDIR fakedir )
    FetchContent_Declare(curl           SOURCE_DIR "${NIX_DEPS_DIR}/curl"           SOURCE_SUBDIR fakedir )
    FetchContent_Declare(incbin         SOURCE_DIR "${NIX_DEPS_DIR}/incbin"         SOURCE_SUBDIR fakedir )
    FetchContent_Declare(asio           SOURCE_DIR "${NIX_DEPS_DIR}/asio"           SOURCE_SUBDIR fakedir )
else()
