...
if (!DISTRO_NIX)
    ...
    FetchContent_Declare(luajit         SOURCE_DIR "${NIX_DEPS_DIR}/luajit")
    FetchContent_Declare(lua_cjson      SOURCE_DIR "${NIX_DEPS_DIR}/luajson")
    FetchContent_Declare(minhook        SOURCE_DIR "${NIX_DEPS_DIR}/minhook")
    FetchContent_Declare(mini           SOURCE_DIR "${NIX_DEPS_DIR}/mini")
    FetchContent_Declare(websocketpp    SOURCE_DIR "${NIX_DEPS_DIR}/websocketpp")
    FetchContent_Declare(fmt            SOURCE_DIR "${NIX_DEPS_DIR}/fmt")
    FetchContent_Declare(nlohmann_json  SOURCE_DIR "${NIX_DEPS_DIR}/json")
    FetchContent_Declare(libgit2        SOURCE_DIR "${NIX_DEPS_DIR}/libgit2")
    FetchContent_Declare(minizip_ng     SOURCE_DIR "${NIX_DEPS_DIR}/minizip")
    FetchContent_Declare(curl           SOURCE_DIR "${NIX_DEPS_DIR}/curl")
    FetchContent_Declare(incbin         SOURCE_DIR "${NIX_DEPS_DIR}/incbin")
    FetchContent_Declare(asio           SOURCE_DIR "${NIX_DEPS_DIR}/asio")
endif()
...
if(DISTRO_NIX)
    include_directories("${NIX_DEPS_DIR}/luajit/src")
endif()
